 ...
 */
public class Union extends CompositeExpression implements CharacterExpression {

    public Union(FinalExpression right, FinalExpression left) {
        super(new CharClass(right, new CharClass(left)));
    }
