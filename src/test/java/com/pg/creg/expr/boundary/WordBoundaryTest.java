...
public class WordBoundaryTest {
    ...
    /**
     * Test of eval method, of class WordBoundary.
     */
    @Test
    public void testEval() throws Exception {
        StringBuilder builder = new StringBuilder();
        WordBoundary instance = new WordBoundary(new Word(), BEGIN);
        instance.eval(builder);
        assertEquals(builder.toString(), "\\b\\w");

        builder = new StringBuilder();
        instance = new WordBoundary(new Word(), END);
        instance.eval(builder);
        assertEquals(builder.toString(), "\\w\\b");

        builder = new StringBuilder();
        instance = new WordBoundary(new Word(), BOTH);
        instance.eval(builder);
